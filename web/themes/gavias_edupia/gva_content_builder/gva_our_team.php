   ...
   class element_gva_our_team{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         //Style display horizontal
          if($style=='horizontal'){ ?>
            <div class="widget gsc-team team-horizontal <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow_delay($animate, $animate_delay) ?>>
               <div class="row">
         ...
         if($style=='vertical'){ ?>
            <div class="widget gsc-team team-vertical <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow_delay($animate, $animate_delay) ?>>
         ...
         //circle
         if($style=='circle'){ ?>
            <div class="widget gsc-team team-vertical team-circle <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_wow_delay($animate, $animate_delay) ?>>
               <div class="widget-content text-center">
                  <div class="team-header text-center">
                     <img alt="<?php print $title ?>" src="<?php print $image ?>" class="img-responsive"> 
                     <div class="box-hover">
