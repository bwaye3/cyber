...
class gavias_bb_fields{
	...
	public function render_field_upload_non_imce($field = array(), $value = ''){
		...
		<div class="gva-upload-image" id="gva-upload-<?php print $_id; ?>">
			<form class="upload" id="upload-<?php print $_id; ?>" method="post" action="<?php print (base_path() . 'admin/structure/gavias_builder/upload') ?>" enctype="multipart/form-data">
				<div class="drop">
